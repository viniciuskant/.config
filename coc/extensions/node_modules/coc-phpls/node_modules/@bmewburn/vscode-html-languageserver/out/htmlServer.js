...
function startServer(connection, runtime) {
    ...
    connection.onInitialize((params) => {
        ...
        const handledSchemas = (_a = initializationOptions === null || initializationOptions === void 0 ? void 0 : initializationOptions.handledSchemas) !== null && _a !== void 0 ? _a : ['file'];
        const fileSystemProvider = (0, requests_1.getFileSystemProvider)(handledSchemas, connection, runtime);
        const workspace = {
            get settings() { return globalSettings; },
            get folders() { return workspaceFolders; }
        };
        languageModes = (0, languageModes_1.getLanguageModes)((initializationOptions === null || initializationOptions === void 0 ? void 0 : initializationOptions.embeddedLanguages) || { css: true, javascript: true }, workspace, params.capabilities, fileSystemProvider);
        ...
        formatterMaxNumberOfEdits = ((_c = (_b = initializationOptions === null || initializationOptions === void 0 ? void 0 : initializationOptions.customCapabilities) === null || _b === void 0 ? void 0 : _b.rangeFormatting) === null || _c === void 0 ? void 0 : _c.editLimit) || Number.MAX_VALUE;
                    ...
                    if (latestTextDocument && latestTextDocument.version === version) {
                        for (const mode of modes) {
                            if (mode.doValidation && isValidationEnabled(mode.getId(), settings)) {
                                (0, arrays_1.pushAll)(diagnostics, yield mode.doValidation(latestTextDocument, settings));
                            }
                        }
                        return diagnostics;
                    }
    ...
    function onFormat(textDocument, range, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (document) {
                ...
                const edits = yield (0, formatting_1.format)(languageModes, document, range !== null && range !== void 0 ? range : getFullRange(document), options, settings, enabledModes);
            ...
            if (document) {
                ...
                for (const m of languageModes.getAllModesInDocument(document)) {
                    if (m.findDocumentLinks) {
                        (0, arrays_1.pushAll)(links, yield m.findDocumentLinks(document, documentContext));
                    }
                }
            }
            return links;
            ...
            if (document) {
                for (const m of languageModes.getAllModesInDocument(document)) {
                    if (m.findDocumentSymbols) {
                        (0, arrays_1.pushAll)(symbols, yield m.findDocumentSymbols(document));
                    }
                }
            }
            return symbols;
            ...
            if (document) {
                for (const m of languageModes.getAllModesInDocument(document)) {
                    if (m.findDocumentColors) {
                        (0, arrays_1.pushAll)(infos, yield m.findDocumentColors(document));
                    }
                }
            }
            return infos;
